											...
											<div class='box'>
												...
												<div class="col-md-5">
														<div class="form-group">
															...
															<form:select path="empresas"
																ng-model="ctrl.mensagem.idEmpresa" class="form-control"
																name="tipo" 
																nama="nomeEmpresa">
															...
															<div class="has-error" ng-show="myForm.$dirty">
																<span ng-show="myForm.nomeEmpresa.$error.required"><spring:message
																		code="campo.obrigatorio" /></span>
															</div>
														</div>
													</div>
													...
													<textarea ng-model="ctrl.mensagem.texto" required
														ng-minlength="10" ng-maxlength="500" name="texto" class="textarea"
													...
													<div class="has-error" ng-show="myForm.$dirty">
														<span ng-show="myForm.texto.$error.required"><spring:message
															...
															minimo para é esse campo é tamanho 10</span>
															<span
